...
$Graphites = @(
    ...
    @{ Name = "Winget"; Path = "C:\Users\himadri\AppData\Local\Packages\Microsoft.DesktopAppInstaller_8wekyb3d8bbwe\LocalState\settings.json"; Get = "Winget/winget-settings.json" }
)
